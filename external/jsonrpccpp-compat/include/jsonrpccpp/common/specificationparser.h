...
namespace jsonrpc {
    ...
    {
        public:
            static std::vector<Procedure> GetProceduresFromFile(const std::string& filename)    noexcept(false);
            static std::vector<Procedure> GetProceduresFromString(const std::string& spec)      noexcept(false);
